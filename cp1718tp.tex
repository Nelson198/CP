...
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{updateLedger}}\comp \Varid{allTransactions}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{updateLedger}\mathbin{::}(\Conid{Transaction},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{updateLedger}\;((e_1 ,(\Varid{v},e_2 )),\Varid{l})\mathrel{=}\Varid{update}\;(e_1 ,\mathbin{-}\Varid{v})\;(\Varid{update}\;(e_2 ,\Varid{v})\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{update}\mathbin{::}(\Conid{Entity},\Conid{Value})\to \Conid{Ledger}\to \Conid{Ledger}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{update}\;(\Varid{e},\Varid{v})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu (\Varid{e},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{update}\;(\Varid{e},\Varid{v})\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\mid \Varid{x}\equiv \Varid{e}\mathrel{=}(\Varid{x},\Varid{y}\mathbin{+}\Varid{v})\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[11]{}\hsindent{27}{}\<[38]%
\>[38]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{x},\Varid{y})\mathbin{:}(\Varid{update}\;(\Varid{e},\Varid{v})\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{check}\comp \Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{check}\mathbin{::}[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{check}\;[\mskip1.5mu \Varid{m}\mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{check}\;(\Varid{x}\mathbin{:}\Varid{xs})\mid \Varid{elem}\;\Varid{x}\;\Varid{xs}\equiv \Conid{True}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[11]{}\hsindent{15}{}\<[26]%
\>[26]{}\mid \Varid{otherwise}\mathrel{=}\Varid{check}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times\Varid{swap})+\Varid{troca})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{troca}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{c},(\Varid{a},(\Varid{d},\Varid{b}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times(\Varid{multiply}\;\Varid{i}))+\Varid{id})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{multiply}\;\Varid{i}\;(\Varid{b},\Varid{c})\mathrel{=}(\Varid{i}\mathbin{*}\Varid{b},\Varid{i}\mathbin{*}\Varid{c}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{subtract}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{subtract}\mathbin{::}\Conid{PixelRGBA8}\to \Conid{PixelRGBA8}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{subtract}\;(\Conid{PixelRGBA8}\;\Varid{red}\;\Varid{green}\;\Varid{blue}\;\Varid{alpha})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{red})\;(\mathrm{255}\mathbin{-}\Varid{green})\;(\mathrm{255}\mathbin{-}\Varid{blue})\;\Varid{alpha}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\mathrm{0}\mathrel{=}\Varid{id}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\Varid{compressQTree}\;(\Varid{n}\mathbin{-}\mathrm{1})\comp \Varid{anaQTree}\;\Varid{compress}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{compress}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int}))+((\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{compress}\;(\Conid{Cell}\;\Varid{x}\;\Varid{y}\;\Varid{z})\mathrel{=}i_1\;(\Varid{x},(\Varid{y},\Varid{z})){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{compress}\;(\Conid{Block}\;(\Conid{Cell}\;\Varid{x1}\;\Varid{y1}\;\Varid{z1})\;(\Conid{Cell}\;\Varid{x2}\;\Varid{y2}\;\Varid{z2})\;(\Conid{Cell}\;\Varid{x3}\;\Varid{y3}\;\Varid{z3})\;(\Conid{Cell}\;\Varid{x4}\;\Varid{y4}\;\Varid{z4}))\mathrel{=}i_1\;(\Varid{x1},((\Varid{y1}\mathbin{+}\Varid{y2}),(\Varid{z1}\mathbin{+}\Varid{z3}))){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{compress}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\[\blanklineskip]%
