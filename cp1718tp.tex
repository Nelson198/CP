...
\begin{tabbing}\tt
~~~~~\char62{}~readBMP~\char34{}Imagens\char47{}person\char46{}bmp\char34{}
\end{tabbing}
...
\begin{enumerate}
    ...
    Tente produzir imagens similares às Figuras~\ref{fig:person90}, \ref{fig:personx2} e \ref{fig:personinv}:
        \begin{tabbing}\tt
~~~~~\char62{}~rotateBMP~~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}person90\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~scaleBMP~2~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}personx2\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~invertBMP~~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}personinv\char46{}bmp\char34{}
\end{tabbing}
...
\end{propriedade}
    ...
    Tente produzir imagens similares (mas não necessariamente iguais) às Figuras~\ref{fig:person1}, \ref{fig:person2}, \ref{fig:person3} e \ref{fig:person4}:
        \begin{tabbing}\tt
~~~~~\char62{}~compressBMP~1~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}person1\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~compressBMP~2~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}person2\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~compressBMP~3~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}person3\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~compressBMP~4~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}person4\char46{}bmp\char34{}
\end{tabbing}
    \begin{propriedade}
...
\end{hscode}\resethooks
    ...
    \item Defina a função \ensuremath{\Varid{outlineQTree}\mathbin{::}(\Varid{a}\to \Conid{Bool})\to \Conid{QTree}\;\Varid{a}\to \Conid{Matrix}\;\Conid{Bool}}, utilizando catamorfismos e/ou anamorfismos, que recebe uma função que determina quais os píxeis de fundo e converte uma quadtree numa matriz monocromática, de forma a desenhar o contorno de uma \href{https://en.wikipedia.org/wiki/Polygon_mesh}{malha poligonal} contida na imagem.
        Tente produzir imagens similares (mas não necessariamente iguais) às Figuras~\ref{fig:personOut1} e \ref{fig:personOut2}:
            \begin{tabbing}\tt
~~~~~\char62{}~outlineBMP~~~~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}personOut1\char46{}bmp\char34{}\\
\tt ~~~~~\char62{}~addOutlineBMP~\char34{}Imagens\char47{}person\char46{}bmp\char34{}~\char34{}Imagens\char47{}personOut2\char46{}bmp\char34{}
\end{tabbing}
    \begin{propriedade}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Big(\vcenter{\xymatrix@R=1pt{\Varid{n}\\\Varid{k}}}\Big)\mathrel{=}\Varid{h}\;\Varid{k}\;(\Varid{n}\mathbin{-}\Varid{k})\;\mathbf{where}\;\Varid{h}\;\Varid{k}\;\Varid{n}\mathrel{=}\mathbf{let}\;(\Varid{a},\anonymous ,\Varid{b},\anonymous )\mathrel{=}\mathsf{for}\ \Varid{loop}\ (\Varid{base}\;\Varid{k})\;\Varid{n}\;\mathbf{in}\;\Varid{a}\mathbin{/}\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{},(\mathit B\;[\mskip1.5mu (\Conid{Pink},\mathrm{1}),(\Conid{Green},\mathrm{2}),(\Conid{Red},\mathrm{1}),(\Conid{Blue},\mathrm{1})\mskip1.5mu],\mathrm{2})\mskip1.5mu],\mathrm{2})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{block})\mathrel{=}i_1\;\Varid{block}{}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{block},\Varid{blockchain}))\mathrel{=}i_2\;(\Varid{block},\Varid{blockchain}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseBlockchain}\;\Varid{f}\;\Varid{k}\mathrel{=}\Varid{f}+(\Varid{f}\times\Varid{k}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBlockchain}\;\Varid{k}\mathrel{=}\Varid{id}+(\Varid{id}\times\Varid{k}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataBlockchain}\;\Varid{c}\mathrel{=}\Varid{c}\comp (\Varid{recBlockchain}\;(\Varid{cataBlockchain}\;\Varid{c}))\comp \Varid{outBlockchain}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaBlockchain}\;\Varid{a}\mathrel{=}\Varid{inBlockchain}\comp (\Varid{recBlockchain}\;(\Varid{anaBlockchain}\;\Varid{a}))\comp \Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloBlockchain}\;\Varid{c}\;\Varid{a}\mathrel{=}\Varid{cataBlockchain}\;\Varid{c}\comp \Varid{anaBlockchain}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;\alt{\p2\comp \p2}{\mathsf{conc}\comp ((\p2\comp \p2)\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{updateLedger}}\comp \Varid{allTransactions}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{updateLedger}\mathbin{::}(\Conid{Transaction},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{updateLedger}\;((\Varid{src},(\Varid{v},\Varid{dst})),[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu (\Varid{src},\mathbin{-}\Varid{v}),(\Varid{dst},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{updateLedger}\;((\Varid{src},(\Varid{v},\Varid{dst})),((\Varid{ent},\Varid{cur})\mathbin{:}\Varid{t}))\mid \Varid{ent}\equiv \Varid{src}\mathrel{=}(\Varid{ent},\Varid{cur}\mathbin{-}\Varid{v})\mathbin{:}\Varid{updateLedger}\;((\Varid{src},(\Varid{v},\Varid{dst})),\Varid{t}){}\<[E]%
\\
\>[5]{}\hsindent{47}{}\<[52]%
\>[52]{}\mid \Varid{ent}\equiv \Varid{dst}\mathrel{=}(\Varid{ent},\Varid{cur}\mathbin{+}\Varid{v})\mathbin{:}\Varid{updateLedger}\;((\Varid{src},(\Varid{v},\Varid{dst})),\Varid{t}){}\<[E]%
\\
\>[5]{}\hsindent{47}{}\<[52]%
\>[52]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{ent},\Varid{cur})\mathbin{:}\Varid{updateLedger}\;((\Varid{src},(\Varid{v},\Varid{dst})),\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{check}\comp \Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{check}\mathbin{::}[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{check}\;[\mskip1.5mu \Varid{m}\mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{check}\;(\Varid{x}\mathbin{:}\Varid{xs})\mid \Varid{elem}\;\Varid{x}\;\Varid{xs}\equiv \Conid{True}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[5]{}\hsindent{15}{}\<[20]%
\>[20]{}\mid \Varid{otherwise}\mathrel{=}\Varid{check}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inQTree}\;(i_2\;(\Varid{q1},(\Varid{q2},(\Varid{q3},\Varid{q4}))))\mathrel{=}\Conid{Block}\;\Varid{q1}\;\Varid{q2}\;\Varid{q3}\;\Varid{q4}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{k}\mathrel{=}(\Varid{f}\times\Varid{id})+(\Varid{k}\times(\Varid{k}\times(\Varid{k}\times\Varid{k}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recQTree}\;\Varid{k}\mathrel{=}(\Varid{id}\times\Varid{id})+(\Varid{k}\times(\Varid{k}\times(\Varid{k}\times\Varid{k}))){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times\Varid{swap})+\Varid{troca}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{troca}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{c},(\Varid{a},(\Varid{d},\Varid{b}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times(\Varid{multiply}\;\Varid{i}))+\Varid{id}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{multiply}\;\Varid{i}\;(\Varid{b},\Varid{c})\mathrel{=}(\Varid{i}\mathbin{*}\Varid{b},\Varid{i}\mathbin{*}\Varid{c}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{subtract}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{subtract}\mathbin{::}\Conid{PixelRGBA8}\to \Conid{PixelRGBA8}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{subtract}\;(\Conid{PixelRGBA8}\;\Varid{red}\;\Varid{green}\;\Varid{blue}\;\Varid{alpha})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{red})\;(\mathrm{255}\mathbin{-}\Varid{green})\;(\mathrm{255}\mathbin{-}\Varid{blue})\;\Varid{alpha}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\mathrm{0}\mathrel{=}\Varid{id}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\Varid{compressQTree}\;(\Varid{n}\mathbin{-}\mathrm{1})\comp \Varid{anaQTree}\;\Varid{compress}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{compress}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int}))+((\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{compress}\;(\Conid{Cell}\;\Varid{x}\;\Varid{y}\;\Varid{z})\mathrel{=}i_1\;(\Varid{x},(\Varid{y},\Varid{z})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{compress}\;(\Conid{Block}\;(\Conid{Cell}\;\Varid{x1}\;\Varid{y1}\;\Varid{z1})\;(\Conid{Cell}\;\Varid{x2}\;\Varid{y2}\;\Varid{z2})\;(\Conid{Cell}\;\Varid{x3}\;\Varid{y3}\;\Varid{z3})\;(\Conid{Cell}\;\Varid{x4}\;\Varid{y4}\;\Varid{z4}))\mathrel{=}i_1\;(\Varid{x1},((\Varid{y1}\mathbin{+}\Varid{y2}),(\Varid{z1}\mathbin{+}\Varid{z3}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{compress}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g}\mathbin{::}((\Varid{t1},\Varid{t2}),(\Varid{t3},\Varid{t4}))\to (\Varid{t1},\Varid{t2},\Varid{t3},\Varid{t4}){}\<[E]%
\\
\>[B]{}\Varid{g}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\mathbin{::}(\Varid{t1},\Varid{t2},\Varid{t3},\Varid{t4})\to ((\Varid{t1},\Varid{t2}),(\Varid{t3},\Varid{t4})){}\<[E]%
\\
\>[B]{}\Varid{h}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\mathbin{::}((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))\to ((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer})){}\<[E]%
\\
\>[B]{}\Varid{f}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{base}\;\Varid{k}\mathrel{=}(\mathrm{1},\succ \;\Varid{k},\mathrm{1},\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{g}\comp \Varid{f}\comp \Varid{h}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inFTree}\;(i_2\;(\Varid{y},(\Varid{ft1},\Varid{ft2})))\mathrel{=}\Conid{Comp}\;\Varid{y}\;\Varid{ft1}\;\Varid{ft2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{y}\;\Varid{ft1}\;\Varid{ft2})\mathrel{=}i_2\;(\Varid{y},(\Varid{ft1},\Varid{ft2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseFTree}\;\Varid{g}\;\Varid{f}\;\Varid{k}\mathrel{=}\Varid{f}+(\Varid{g}\times(\Varid{k}\times\Varid{k})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recFTree}\;\Varid{k}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{k}\times\Varid{k})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataFTree}\;\Varid{c}\mathrel{=}\Varid{c}\comp (\Varid{recFTree}\;(\Varid{cataFTree}\;\Varid{c}))\comp \Varid{outFTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaFTree}\;\Varid{a}\mathrel{=}\Varid{inFTree}\comp (\Varid{recFTree}\;(\Varid{anaFTree}\;\Varid{a}))\comp \Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloFTree}\;\Varid{c}\;\Varid{a}\mathrel{=}\Varid{cataFTree}\;\Varid{c}\comp \Varid{anaFTree}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;((\underline{\mathrm{1.0}}+\conj{(\Varid{sqrt}\;(\mathrm{2})\mathbin{\uparrow})\comp \succ }{\conj{\Varid{id}}{\Varid{id}}})\comp \Varid{outNat}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTreeAux}\;\Varid{p}\mathrel{=}\Varid{aux}\;\Varid{p}\;(\mathrm{0},\mathrm{0})\;\mathrm{0}\;\mathrm{0}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{aux}\mathbin{::}\Conid{PTree}\to (\Conid{Float},\Conid{Float})\to \Conid{Float}\to \Conid{Int}\to [\mskip1.5mu (\Conid{Int},\Conid{Picture})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Conid{Unit}\;\Varid{c})\;(\Varid{x},\Varid{y})\;\Varid{ang}\;\Varid{n}\mathrel{=}[\mskip1.5mu (\Varid{n},\Conid{Translate}\;\Varid{x}\;\Varid{y}\;(\Conid{Rotate}\;\Varid{ang}\;(\Varid{square}\;\Varid{c})))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Conid{Comp}\;\Varid{c}\;\Varid{l}\;\Varid{r})\;(\Varid{x},\Varid{y})\;\Varid{ang}\;\Varid{n}\mathrel{=}[\mskip1.5mu (\Varid{n},\Varid{currentPic})\mskip1.5mu]\plus {}\<[E]%
\\
\>[5]{}\hsindent{32}{}\<[37]%
\>[37]{}(\Varid{aux}\;\Varid{l}\;(\Varid{x}\mathbin{+}\Varid{somaXLeft},\Varid{y}\mathbin{+}\Varid{somaYLeft})\;(\Varid{ang}\mathbin{-}\mathrm{45})\;(\Varid{n}\mathbin{+}\mathrm{1}))\plus {}\<[E]%
\\
\>[5]{}\hsindent{32}{}\<[37]%
\>[37]{}(\Varid{aux}\;\Varid{r}\;(\Varid{x}\mathbin{+}\Varid{somaXRight},\Varid{y}\mathbin{+}\Varid{somaYRight})\;(\Varid{ang}\mathbin{+}\mathrm{45})\;(\Varid{n}\mathbin{+}\mathrm{1}))\;\mathbf{where}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{somaX}\mathrel{=}\Varid{c}\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{somaY}\mathrel{=}\Varid{c}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{angRads}\mathrel{=}\Varid{ang}\mathbin{*}\Varid{pi}\mathbin{/}\mathrm{180}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{branchToGlobal}\;\Varid{angle}\;(\Varid{dx},\Varid{dy})\mathrel{=}(\Varid{dx}\mathbin{*}\Varid{cos}\;\Varid{angle}\mathbin{+}\Varid{dy}\mathbin{*}\Varid{sin}\;\Varid{angle},\Varid{dy}\mathbin{*}\Varid{cos}\;\Varid{angle}\mathbin{-}\Varid{dx}\mathbin{*}\Varid{sin}\;\Varid{angle}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}(\Varid{somaXLeft},\Varid{somaYLeft})\mathrel{=}\Varid{branchToGlobal}\;\Varid{angRads}\;(\mathbin{-}\Varid{somaX},\Varid{somaY}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}(\Varid{somaXRight},\Varid{somaYRight})\mathrel{=}\Varid{branchToGlobal}\;\Varid{angRads}\;(\Varid{somaX},\Varid{somaY}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{currentPic}\mathrel{=}\Conid{Translate}\;\Varid{x}\;\Varid{y}\;(\Conid{Rotate}\;\Varid{ang}\;(\Varid{square}\;\Varid{c})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sortGT}\mathbin{::}(\Conid{Int},\Varid{a})\to (\Conid{Int},\Varid{a})\to \Conid{Ordering}{}\<[E]%
\\
\>[B]{}\Varid{sortGT}\;(\Varid{a1},\Varid{b1})\;(\Varid{a2},\Varid{b2})\mid \Varid{a1}\mathbin{<}\Varid{a2}\mathrel{=}\Conid{LT}{}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\mid \Varid{a1}\mathbin{>}\Varid{a2}\mathrel{=}\Conid{GT}{}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\mid \Varid{a1}\equiv \Varid{a2}\mathrel{=}\Conid{LT}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{accumCata}\comp \map \;(\Conid{Pictures}\comp \map \;\p2)\comp \Varid{grouping}\comp \Varid{drawPTreeAux}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{grouping}\mathrel{=}\Varid{groupBy}\;(\lambda (\Varid{l1},\Varid{pic1})\;(\Varid{l2},\Varid{pic2})\to \Varid{l1}\equiv \Varid{l2})\comp \Varid{sortBy}\;\Varid{sortGT}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{accumCata}\mathrel{=}\Varid{reverse}\comp \Varid{cataList}\;\alt{\Varid{nil}}{\Varid{f}}\comp \Varid{reverse}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\mathrel{=}\Varid{cons}\comp \conj{\Conid{Pictures}\comp \Varid{cons}}{\p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{extractBag}\comp \Varid{unB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{extractBag}\mathbin{::}[\mskip1.5mu (\Conid{Bag}\;\Varid{a},\Conid{Int})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{extractBag}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{extractBag}\;((\mathit B\;((\Varid{x},\Varid{y})\mathbin{:}[\mskip1.5mu \mskip1.5mu]),\Varid{i})\mathbin{:}[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{x},\Varid{y}\mathbin{*}\Varid{i})\mathbin{:}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{extractBag}\;((\mathit B\;((\Varid{x},\Varid{y})\mathbin{:}{}\<[27]%
\>[27]{}\Varid{t}),\Varid{i})\mathbin{:}[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{x},\Varid{y}\mathbin{*}\Varid{i})\mathbin{:}\Varid{extractBag}\;((\mathit B\;\Varid{t},\Varid{i})\mathbin{:}[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{extractBag}\;((\mathit B\;((\Varid{x},\Varid{y})\mathbin{:}[\mskip1.5mu \mskip1.5mu]),\Varid{i})\mathbin{:}\Varid{ts})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{*}\Varid{i})\mathbin{:}\Varid{extractBag}\;\Varid{ts}{}\<[E]%
\\
\>[B]{}\Varid{extractBag}\;((\mathit B\;((\Varid{x},\Varid{y})\mathbin{:}{}\<[27]%
\>[27]{}\Varid{t}),\Varid{i})\mathbin{:}\Varid{ts})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{*}\Varid{i})\mathbin{:}\Varid{extractBag}\;((\mathit B\;\Varid{t},\Varid{i})\mathbin{:}\Varid{ts}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\mathbin{::}\Conid{Bag}\;\Varid{a}\to \fun{Dist}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \Varid{genProb}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{genProb}\;\Varid{b}\mathrel{=}\map \;\Varid{getProb}\;(\Varid{unB}\;\Varid{b})\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{getProb}\;(\Varid{a},\Varid{c})\mathrel{=}(\Varid{a},(\Varid{fromIntegral}\;\Varid{c}\mathbin{/}\Varid{totalN}\;\Varid{b})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{totalN}\mathrel{=}\Varid{fromIntegral}\comp \p2\comp \Varid{head}\comp \Varid{consol}\comp \Varid{unB}\comp \Varid{countBag}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{countBag}\mathrel{=}\mathsf{fmap}\;(\mathbin{!}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
